...
![Versi](https://img.shields.io/badge/versi-1.3.3-brightgreen)
...
| Versi | File | Link |
|---|---|---|
| **v1.3.3** (terbaru) | `app-debug.apk` (debug) / `app-release.apk` (release) | **⬇️ [Download dari GitHub Releases](https://github.com/ngodingsendiri/Money-chat/releases/latest)** |
| Semua versi | — | [Daftar Release](https://github.com/ngodingsendiri/Money-chat/releases) |
| Build mentah (artifact) | `MoneyChat-v1.3.3-debug` (zip) | [Actions → Build APK](https://github.com/ngodingsendiri/Money-chat/actions/workflows/build-apk.yml) |
